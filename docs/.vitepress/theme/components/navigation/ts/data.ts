import type { NavCategory } from '@components/navigation/ts/class'

const DEFAULT_ICON = '/icons/default-nav.svg'

export const NAV_CATEGORY_LIST: NavCategory[] = [
    {
        title: '常用工具',
        items: [
            {
        ...
        items: [
            {
                ...
                desc: '',
                link: 'https://app.apifox.com/project/6875268'
            },
            {
                icon: DEFAULT_ICON,
                title: '在线加解密',
                ...
                desc: '',
                link: 'http://10.31.85.36:8082/hydsi/secret/'
            },
            {
                icon: DEFAULT_ICON,
                title: '文献计量分析',
                ...
                desc: '',
                link: 'https://agentx.cnki.net/opweb/app/762cf2ab-7f4d-436b-8203-1904979ff984/logs'
            },
            {
                icon: DEFAULT_ICON,
                title: 'OA',
                ...
                desc: '',
                link: 'https://oa.cnki.net/web/account/login'
            },
            {
                icon: DEFAULT_ICON,
                title: '邮箱',
                ...
                desc: '',
                link: 'https://mail.cnki.net/coremail/index.jsp'
            }
        ]
    },
    {
        ...
        items: [
            {
                ...
                desc: '',
                link: 'https://www.cnblogs.com/wmyskxz/category/2494720.html'
            },
            {
    ...
    },
    {
        ...
        items: [
            ...
            {
                icon: 'https://avatars.githubusercontent.com/u/22293321?s=200&v=4',
                title: 'ElementUI',
                badge: {
                    text: '常用',
                    type: 'danger',
    ...
    },
    {
        ...
        items: [
            ...
            {
                icon: 'https://vp.teek.top/teek-logo-large.png',
