---
# 另一种实现方式 titleTag: 手册
title: Frontmatter 配置 <TkTitleTag type="tip" text="手册" position="right" />
outline: [2, 3] # 右侧页内导航展示几级，默认: [2] （只展示 h2 ）
coverImg: /img/人物/爱丽丝.jpg
date: 2025-03-07 00:52:36
permalink: /reference/frontmatter # 页面永久链接
navbar: true # 是否展示顶部导航
# 列表的两种写法，categories: ['', ''] 或者 ↓
categories:
  - 使用手册
tags:
  - frontmatter
